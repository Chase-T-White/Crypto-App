  ...
  return (
    <div>
      <ErrorBoundary fallback={<p>Something went wrong</p>}>
        <div className="relative flex items-center justify-center py-5 text-xsm font-medium text-[#D1D1D1] bg-dark-purple-500 dark:bg-dark-purple-800 border-b border-[#ffffff1a]">
            ...
            <div className="flex gap-8">
              ...
              <div className="flex items-center gap-[5px]">
                ...
                <div
                  ...
                  className="w-[50px] h-[6px] relative rounded overflow-hidden"
                >
